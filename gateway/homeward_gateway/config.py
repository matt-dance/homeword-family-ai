...
class Settings(BaseSettings):
    ...
    # Do not declare cloud_enabled / openai_api_key. Leftover
    # HOMEWARD_CLOUD_ENABLED and HOMEWARD_OPENAI_API_KEY would bind here and
    # silently send kid chats to OpenAI (removed; unsupported; see SECURITY.md).
