...
import { asChildList } from "@/lib/public-children";
import { getAgeThemeConfig } from "@/lib/age-theme";
...
export function ChatPickerFallback() {
  return (
...
export function ChatPickerContent() {
    ...
    api
      ...
      .then((kids) => {
        ...
        if (!forcePick) {
          ...
          const savedChild = findChildById(list, savedId);
          if (savedChild) {
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="mx-auto flex-1 max-w-lg w-full p-6 sm:p-10 flex flex-col justify-center animate-fade-in">
        ...
        <div className="space-y-3.5">
          {children.map((child) => {
            const theme = getAgeThemeConfig(child);
